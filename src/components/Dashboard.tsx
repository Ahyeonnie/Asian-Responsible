...
const dashboardNavItems = [
  { id: 'home', label: 'Home', icon: HomeIcon, component: DashboardHome },
...
export default function Dashboard({ user, onLogout, isDark, onToggleTheme }: DashboardProps) {
  ...
  const ActiveComponent = dashboardNavItems.find(item => item.id === activeSection)?.component || DashboardHome;
